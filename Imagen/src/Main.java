...
public class Main extends JFrame{
	...
	public void paint(Graphics g)
    {
        ...
        g.setColor(new Color(54,35,35));
        int [] dx = {36,42,47,48,71,73,76,88,96,108,114,
        		116,139,142,148,150,171,174,175,188,199,
        		205,212,223,228,254,265,278,293,297,298,
        		295,286,270,256,247,228,208,196,186,180,
        		162,155,146,114,104,80,78,69,46,43,26,22,0};
        int [] dy = {112,106,111,108,111,107,112,110,116,
        		108,112,108,111,106,111,107,112,107,112,
        		110,116,111,111,123,112,109,117,109,122,
        		114,136,152,157,159,151,158,155,157,157,
        		154,157,156,153,156,156,158,159,152,158,
        		160,154,159,152,159};
        g.fillPolygon(dx, dy, 54);
